...
public class ABC087B {
    public static void main(String[] args) {
        try(Scanner sc = new Scanner(System.in)) {
            ...
            long result = 全回答.回答List().stream().filter(x ->合計金額が予定通り(input,x)).count();
    ...
    public static boolean 合計金額が予定通り(入力値 input , 計算結果と内容 value){
